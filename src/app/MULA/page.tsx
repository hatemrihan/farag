...
import mazenFiveImage from '@/assets/images/mazenFive-image.jpg';
import mazenSixImage from '@/assets/images/mazenSix-image.jpg';
import mazenSevenImage from '@/assets/images/mazenSeven-image.jpg';
    ...
    <main className="min-h-screen bg-stone-100 text-black relative">
      ...
      <div className="relative">
        ...
        <div className="w-full flex flex-col items-center justify-center pt-20 pb-10 px-4 relative z-10">
          <p className="text-sm uppercase tracking-widest mb-4">MULA</p>
